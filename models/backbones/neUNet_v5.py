...
class DoubleDeformableConvStriped(nn.Module):
    """Striped Conv"""

    def __init__(self, in_channels, out_channels,kernel_size = 3):
        super().__init__()
        self.double_conv = nn.Sequential(
            DeformableConv2d(in_channels, in_channels, kernel_size=(1, kernel_size), padding=(0, kernel_size//2), bias=False),
            DeformableConv2d(out_channels, out_channels, kernel_size=(kernel_size, 1), padding=(kernel_size//2, 0), bias=False),
...
class MSABlock(nn.Module):
    ...
    def __init__(self,channels):
        super().__init__()
        self.strip_conv1 = DoubleDeformableConvStriped(channels,channels,kernel_size=3)
        self.strip_conv2 = DoubleDeformableConvStriped(channels,channels,kernel_size=7)
        self.strip_conv3 = DoubleDeformableConvStriped(channels,channels,kernel_size=11)
